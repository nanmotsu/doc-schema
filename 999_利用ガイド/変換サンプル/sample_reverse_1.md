...
![](assets/sample_reverse_img_001_1.png)

図5.1 Markdown変換パイプラインのフローチャート

## 5.2. シーケンス図（図番号・キャプション付き）

![](assets/sample_reverse_img_002_1.png)

図5.2 ログイン処理のシーケンス図

## 5.3. キャプションなし（図番号のみ）

![](assets/sample_reverse_img_003_1.png)
...
![](assets/sample_reverse_img_004_1.png)
...
![](assets/sample_reverse_img_005_1.png)

図6.1 システム構成の概要図

## 8.7. figure（図 — internal起点・幅指定）

![](assets/sample_reverse_img_006_1.png)

図6.2 幅を60%に指定した図

ピクセル指定も可能です。

![](assets/sample_reverse_img_007_1.png)
...
![](assets/sample_reverse_img_008_1.png)

図6.4 左揃えで表示した図

中央揃え（デフォルト）：

![](assets/sample_reverse_img_009_1.png)

図6.5 中央揃えで表示した図

右揃え：

![](assets/sample_reverse_img_010_1.png)
